...
- Copie um template de `templates/` (ex.: `python/README.md` ou `javascript-node/README.md` ou `frontend/README.md` para escolher um starter pack, ou `python-fastapi/agent-instructions.md` para FastAPI direto)
